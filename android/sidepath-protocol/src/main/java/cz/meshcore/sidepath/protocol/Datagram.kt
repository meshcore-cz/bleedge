...
/**
 * A Sidepath datagram — the end-to-end routing unit (docs/PROTOCOL.md §6). It is
 ...
 */
data class Datagram(
    val version: Int = Sidepath.DATAGRAM_VERSION,
    ...
    companion object {
        ...
        fun newDatagramId(): ByteArray =
            ByteArray(Sidepath.DATAGRAM_ID_BYTES).also { SecureRandom().nextBytes(it) }
    }
}
